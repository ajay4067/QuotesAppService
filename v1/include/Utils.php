...
//        $mail->Port = MAIL_PORT;
    ...
    public function sendVerificationEmail($email, $timeStamp) {
        ...
        $base_url = 'http://jaagar.org/QuotesAppService/v1/activateUser/';
    ...
    public function sendResetEmail($email, $resetId) {
        $base_url = 'http://jaagar.org/QuotesAppService/v1/forgotPswd/resetPermission/';
        $base_url = 'http://localhost/QuotesAppService/v1/forgotPswd/resetPermission/';
        $mail = $this->getMailHandller();
        $mail->addAddress($email, 'Ajay More');
        $mail->addReplyTo('ajmore.biz@gmail.com', 'Information');
